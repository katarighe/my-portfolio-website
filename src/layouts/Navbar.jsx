      ...
      <header className="">
        ...
        >
          <div className="flex lg:flex-1">
            <Link to="/">
              <span className="sr-only font-semibold md:font-bold text-lg md:text-xl font-robotoCondensed">
                Portfolio
              </span>
              ...
              <div className="flex flex-col justify-center gap-16 items-start md:items-center md:flex-row md:py-24">
                <ul className="space-y-3 md:space-y-6">
                  {navigation.map((item) => (
                    <li
                      key={item.name}
                      className="flex justify-start items-center group/item mb-4"
                    >
                      <Link
                        to={item.href}
                        onClick={() => setMobileMenuOpen(false)}
                        className="uppercase text-6xl flex-gap-10 mb-2 font-robotoCondensed font-bold text-black md:text-6xl hover:scale-110 transition-transform duration-300"
                      >
                        {item.name}
                      </Link>
                    </li>
